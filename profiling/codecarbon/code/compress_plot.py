...
data = pd.read_csv('compress_emissions.csv')
...
plt.title('Time Series Compress: Duration vs Timestamp')
...
ax1.set_title('Time Series Compress: Emissions vs Timestamp')
ax1.grid(True)

ax2.plot(data['timestamp'], data['emissions_rate'], marker='o')
ax2.set_xlabel('Timestamp')
ax2.set_ylabel('Emissions Rate in CO₂eq in (kg/second) x 1e-6')
ax2.set_title('Time Series Compress: Emissions Rate vs Timestamp')
ax2.grid(True)
...
plt.title('Histogram Compress: Emissions')
plt.legend()
...
plt.title('Histogram Compress: Emissions Rate')
plt.legend()
...
plt.title('Histogram Compress: CPU Energy')
plt.legend()
...
plt.title('Histogram Compress: RAM Energy')
plt.legend()
...
plt.title('Histogram Compress: Energy Consumed')
plt.legend()
