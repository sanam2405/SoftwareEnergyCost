...
data = pd.read_csv('decompress_emissions.csv')
...
plt.title('Time Series Decompress: Duration vs Timestamp')
...
ax1.set_title('Time Series Decompress: Emissions vs Timestamp')
ax1.grid(True)

ax2.plot(data['timestamp'], data['emissions_rate'], marker='o')
ax2.set_xlabel('Timestamp')
ax2.set_ylabel('Emissions Rate in CO₂eq in (kg/second) x 1e-6')
ax2.set_title('Time Series Decompress: Emissions Rate vs Timestamp')
ax2.grid(True)
...
plt.title('Histogram Decompress: Emissions')
plt.legend()
...
plt.title('Histogram Decompress: Emissions Rate')
plt.legend()
...
plt.title('Histogram Decompress: RAM Power')
plt.legend()
...
plt.title('Histogram Decompress: CPU Energy')
plt.legend()
...
plt.title('Histogram Decompress: RAM Energy')
plt.legend()
...
plt.title('Histogram Decompress: Energy Consumed')
plt.legend()
